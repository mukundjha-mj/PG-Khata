...
const sections = [
  ...
  {
    title: "4. Access and messaging allowance",
    body: "During the current rollout, core property, tenant, billing, reporting and document features are available without a paid plan. WhatsApp sending is subject to a calendar-month allowance assigned to your account. We may adjust an allowance or make a higher allowance available at our discretion to manage messaging capacity and prevent abuse.",
  },
  {
    title: "5. Tenant data you upload",
  ...
  },
  {
    ...
    body: "You agree not to use the Service to send unlawful, harassing or misleading communications to tenants, to attempt to bypass message allowances or security controls, or to interfere with the platform's normal operation. We may suspend an account that we reasonably believe is being used this way.",
  },
  {
    title: "7. Third party services",
    body: "The Service relies on third parties to work: Supabase for data storage, Resend for transactional email, and the Meta WhatsApp Cloud API for WhatsApp reminders. Their availability affects ours; we are not liable for outages or failures originating on their end.",
  },
  {
    title: "8. Availability and liability",
    body: `The Service is provided on an "as is" basis without warranties of any kind. We take reasonable care with backups and uptime but do not guarantee uninterrupted access. To the extent permitted by law, ${BRAND}'s liability for any claim arising from your use of the Service is limited to the amount you paid to us for the Service in the three months before the claim arose.`,
  },
  {
